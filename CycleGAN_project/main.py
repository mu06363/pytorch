...
parser.add_argument("--data_dir", default="./CycleGAN_project/datasets/monet2photo", type=str, dest="data_dir")
parser.add_argument("--ckpt_dir", default="./CycleGAN_project/checkpoint", type=str, dest="ckpt_dir")
parser.add_argument("--log_dir", default="./CycleGAN_project/log", type=str, dest="log_dir")
parser.add_argument("--result_dir", default="./CycleGAN_project/result", type=str, dest="result_dir")
...
parser.add_argument('--norm', default='inorm', choices=['bnorm', 'inorm'], dest='norm')
