...
def save(ckpt_dir, netG_a2b, netG_b2a, netD_a, netD_b, optimG, optimD, epoch):
    ...
    torch.save({'netG_a2b': netG_a2b.state_dict(), 'netG_b2a': netG_b2a.state_dict(), 'netD_a': netD_a.state_dict(), 'netD_b': netD_b.state.dict(), 'optimG': optimG.state_dict(), 'optimD': optimD.state_dict()}, './%s/model_epoch%d.pth' % (ckpt_dir, epoch))
